...
#' Use for creating "sparse.matrix" objects
#'
#' @description This function is used for creating "sparse.matrix" objects. 
#' "sparse.matrix" objects includes two parts. 
#' The first part is a sparse.matrix indicating the location and value of non-zero entries.
...
#' @param j A vector indicating the column coordinate of non-zero entries of the matrix
